...
Your assignment is to demonstrate that you can create bar graphs and histograms using ggplot.

First, create a new R script where you will build the code for your analysis. Keep your script neat with appropriate code sections and descriptive comments throughout. Load the tidyverse package.

Read the intro to each dataset and create the requested graphs *in your R script.*

Only *after* you have a working R script should you attempt to complete your lab report. Open your lab-report.Rmd and replace all triple underscores "\_\_\_" with your answers. Some questions may require you to insert an R code chunk and paste in code from your R script.
...
**Create a graph depicting the frequency distribution of the 35 mass measurements. It should have legible text and appropriate axis labels.**
