...
1. Instructor downloads the entire data set (> 150 GB) and puts it on the Class Share drive
...
NEON data is available here: https://www.neonscience.org/data
...
The package **neonUtilities** allows you to access and download NEON data as well as to work with NEON data downloaded from the portal.
