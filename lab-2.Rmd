...
### Copy code to the R Markdown document

Open the assignment.Rmd document and look for this part:
...
Copy the code from your R script and paste it in between the two lines that start with three backticks. For example:
