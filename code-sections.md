...
![Screenshot of a script with three code sections showing the Document Outline](screenshots/code-sections-r.png)
...
![Example of an R Markdown document showing the Document Outline](screenshots/code-sections-rmd.png)
