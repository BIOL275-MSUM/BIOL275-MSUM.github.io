...
Your assignment is to create a markdown document showing all of the figures you created in your `hw02.R` script. You will do this by copying the appropriate code into code chunks in your `.Rmd` file, and adding any necessary headings and text to explain what each figure represents.
