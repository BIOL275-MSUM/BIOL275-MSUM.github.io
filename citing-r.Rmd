...
> All analyses were performed using R Statistical Software (v4.1.2; R Core Team 2024) in the RStudio IDE (Posit team 2024). We used the tidyverse R packages (Wickham et al. 2019) including readr, dplyr, ggplot2. Maps were created using the rnaturalearth (v 1.0.1; Massicotte and South 2023) and sf (Pebesma and Bivand 2023, Pebesma 2018) R packages.
